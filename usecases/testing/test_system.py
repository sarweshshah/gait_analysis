...
def test_imports():
    ...
    # Test core pose processor manager
    from core.pose_processor_manager import PoseProcessorManager
    ...
    try:
        ...
        if "tensorflow" in str(e).lower():
            ...
            # Re-raise the exception if it's not a TensorFlow-related import error
            raise
...
def test_pose_processor_integration():
    ...
    if PoseProcessorManager is None:
        ...
        pytest.skip("PoseProcessorManager not available")
