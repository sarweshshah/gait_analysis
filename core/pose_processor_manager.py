...
class PoseProcessorManager:
    ...
    AVAILABLE_MODELS = {"mediapipe": "MediaPipe Pose"}
    ...
    def get_model_info(model_type: str) -> Dict[str, Any]:
        ...
        if model_type == "mediapipe":
            return {
                ...
                "disadvantages": ["Lower accuracy compared to deep learning models", "Limited to 2D pose estimation"],
...
class UnifiedPoseProcessor:
    ...
    def __init__(self, model_type: str = "mediapipe", output_dir: str = "outputs/mediapipe", **kwargs):
        """
        ...
        self.processor = PoseProcessorManager.create_processor(
            model_type=self.model_type, output_dir=model_output_dir, **kwargs
        )
        ...
        for model_type in models:
            ...
            try:
                ...
                temp_processor = PoseProcessorManager.create_processor(
                    model_type=model_type, output_dir=os.path.join(self.output_dir, f"comparison_{model_type}")
                )
