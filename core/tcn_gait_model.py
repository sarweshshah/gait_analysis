...
class GaitTCN(keras.Model):
    ...
    def _build_layers(self):
        ...
        self.initial_conv = layers.Conv1D(filters=self.num_filters, kernel_size=1, padding="same", name="initial_conv")
...
def create_gait_tcn_model(input_shape: Tuple[int, int], task_type: str = "phase_detection", **kwargs) -> keras.Model:
    """
...
def compile_gait_model(
    model: keras.Model, task_type: str = "phase_detection", learning_rate: float = 0.001
) -> keras.Model:
    """
